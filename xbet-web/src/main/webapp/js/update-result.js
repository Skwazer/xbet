var isTeam1GoalsCorrect = true;
var isTeam2GoalsCorrect = true;
...
function team1GoalsMessage(result) {
    if (result === 'SUCCESS') {
        ...
        $('#team1GoalsDiv').html("<p style='color: red'><c:out value='${goalsIncorrect}'/></p>");
        $('#team1GoalsDiv').css("display", "block")
    }
}
...
function team2GoalsMessage(result) {
    if (result === 'SUCCESS') {
        ...
        $('#team2GoalsDiv').html("<p style='color: red'><c:out value='${goalsIncorrect}'/></p>");
        $('#team2GoalsDiv').css("display", "block")
    }
}
...
function changeFormAction() {
    ...
    if (result) {
        ...
        form.action = "<c:url value='/main/change/result'/>";
        form.submit();
    } else {
