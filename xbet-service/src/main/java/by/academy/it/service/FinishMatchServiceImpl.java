 ...
 *
 */
class FinishMatchServiceImpl implements FinishMatchService {

    private static final Logger logger = LoggerFactory.getLogger(FinishMatchServiceImpl.class);
    ...
    /**
     * Constructs an instance of the {@code FinishMatchService}.
     */
    FinishMatchServiceImpl(BetDao betDao, TransactionalDao transactionalDao, UserDao userDao) {
        this.betDao = betDao;
        this.transactionalDao = transactionalDao;
        this.userDao = userDao;
        logger.info("FinishMatchService has been created");
    }
